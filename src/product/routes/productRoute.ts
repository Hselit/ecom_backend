...
router.post("/", validatorMiddleware(createProductDto), (req,res,next)=>productController.createProduct(req,res,next));
...
router.put("/:id", validatorMiddleware(updateProductDto), (req,res,next)=>productController.updateProduct(req,res,next));
